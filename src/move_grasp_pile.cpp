...
/*******************approach********************************/
  ...
  Eigen::Affine3d approach = Eigen::Translation3d(0.76, -0.42, 1.2)
...
Eigen::Affine3d pick = approach.translate(0.12*Eigen::Vector3d::UnitX());
...
/**********************Retreat *****************************/
  Eigen::Affine3d retreat = pick.translate(-0.12*Eigen::Vector3d::UnitX());
  ROS_INFO("Going to Retreat");
  group.setPoseTarget(retreat);
  group.move();

/**********************Place it *****************************/
  Eigen::Affine3d place = Eigen::Translation3d(-0.133, -0.287, 0.895)
...
/********************Placing ********************************/
  Eigen::Affine3d placing = place.translate(0.02*Eigen::Vector3d::UnitZ());
  ROS_INFO("Placing");
...
/**********************Retreat Again*****************************/
  Eigen::Affine3d retreat2 = placing.translate(-0.15*Eigen::Vector3d::UnitZ());
  ROS_INFO("Going to Retreat");
